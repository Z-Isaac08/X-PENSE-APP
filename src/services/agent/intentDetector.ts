...
export const detectIntent = (message: string): Intent => {
  ...
  const patterns = {
    query_data: [
      ...
      'montant', 'total', 'dépensé', 'reste', 'restant',
      'budget', 'catégorie', 'revenus', 'dépenses',
      'où en suis', 'situation'
    ],
    analysis: [
      'analyse', 'analyser', 'résumé', 'bilan',
      'comment vont', 'état', 'tendance', 'évolution',
      'comparaison', 'comparer', 'différence'
    ],
    advice: [
      'conseil', 'conseille', 'aide', 'aider',
      'économiser', 'épargner', 'optimiser', 'améliorer',
      'comment faire', 'que faire', 'suggestion'
    ],
    prediction: [
      'prédiction', 'prévoir', 'estimer', 'projection',
      'finir le mois', 'fin de mois', 'à ce rythme',
      'si je continue', 'dans 6 mois', 'futur'
    ],
    action_create: [
      'créer', 'crée', 'ajouter', 'ajoute', 'nouveau', 'nouvelle',
      'enregistrer', 'enregistre'
    ],
    action_modify: [
      'modifier', 'modifie', 'changer', 'change',
      'augmenter', 'augmente', 'diminuer', 'diminue',
      'mettre à jour', 'update'
    ],
    action_delete: [
      'supprimer', 'supprime', 'effacer', 'efface',
      'retirer', 'retire', 'enlever', 'enlève'
    ]
  };
  ...
  // Si aucun mot-clé trouvé, c'est du chat général
 ...
 */
const extractParameters = (message: string, intent: IntentType): Record<string, any> | undefined => {
